...
PM_START_TEXT = """
`Hey There!` [👩‍💼](file:///C:/Users/muzahid/Downloads/profile%202.webp) `My name is` *sara*
`I am cute group management bot.
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD sara TO YOUR GROUP ➕️",url="t.me/saraxyzbot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(
    ...
    [     InlineKeyboardButton(
            text="🎦 H.S.A Group", url="https://t.me/dsfcxyz"),
    
    ],
          

InlineKeyboardButton(
            text="🐱 SUPPORT", url="https://t.me/dsfcxyz"
        ),
...
HELP_STRINGS = """
`Hey there! My name is` [sara]("file:///C:/Users/muzahid/Downloads/profile%202.webp") 
I'm a Sara and help admins manage their groups `Have a look at the following for an idea of some of the things I can help you with.`"""
...
def gabi_about_callback(update, context):
    ...
    if query.data == "gabi_":
        query.message.edit_text(
            text=""" ℹ️ I'm *sara*, a powerful group management bot built to help you manage your group easily.
